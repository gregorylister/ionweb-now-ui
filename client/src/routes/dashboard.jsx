...
var dashRoutes = [
    ...
    { collapse: true, path: "/forms", name: "Forms", state: "openForms", icon: "design_bullet-list-67", views:
    ...
    { collapse: true, path: "/tables", name: "Tables", state: "openTables", icon: "files_single-copy-04", views:
    ...
    { collapse: true, path: "/maps", name: "Maps", state: "openMaps", icon: "location_pin", views:
    ...
    { path: "/widgets", name: "Widgets", icon: "objects_diamond", component: Widgets },
    { path: "/charts", name: "Charts", icon: "business_chart-pie-36", component: Charts },
