            ...
            <div>
                ...
                <div className="content">
                    <Card>
                        <Row>
                            <Col xs={12} md={6}>
                                <CardHeader><CardTitle>Pick your Color</CardTitle></CardHeader>
                                <CardBody>
                            ...
                            <Col xs={12} md={6}>
                                <CardHeader><CardTitle>Buttons with Label</CardTitle></CardHeader>
                                <CardBody>
                                    <Button leftLabel="now-ui-icons arrows-1_minimal-left">Left</Button>
                                    <Button color="primary" rightLabel="now-ui-icons arrows-1_minimal-right">Right</Button>
                                    <Button color="info" leftLabel="now-ui-icons travel_info">Info</Button>
                                    <Button color="success" leftLabel="now-ui-icons ui-1_check">Success</Button>
                                    <Button color="warning" leftLabel="now-ui-icons ui-2_time-alarm">Warning</Button>
                                    <Button color="danger" leftLabel="now-ui-icons ui-1_simple-remove">Danger</Button>
                                </CardBody>
                            </Col>
                        </Row>
                        <Row>
                            <Col xs={12} md={6}>
                                <CardHeader><CardTitle>Pick your Size</CardTitle></CardHeader>
                                <CardBody>
                            ...
                            <Col xs={12} md={6}>
                                <CardHeader><CardTitle>Pick your Style</CardTitle></CardHeader>
                                <CardBody>
                                    <Button color="primary">Default</Button>
                                    <Button color="primary" round>Round</Button>
                                    <Button color="primary" round><i className="now-ui-icons ui-2_favourite-28"></i> with icon</Button>
                                    <Button color="primary" round icon><i className="now-ui-icons ui-2_favourite-28"></i></Button>
                        ...
                        <Row>
                            ...
                            <Col md={6} xs={12}>
                                <CardHeader><CardTitle>Button Group</CardTitle></CardHeader>
                                <CardBody>
                                    <ButtonGroup>
                                    ...
                                    <ButtonToolbar>
                                        <ButtonGroup>
                                            <Button round color="info">1</Button>
                                            <Button round color="info">2</Button>
                                            <Button round color="info">3</Button>
                                            <Button round color="info">4</Button>
                                        </ButtonGroup>
                                        <ButtonGroup>
                                            <Button round color="info">5</Button>
                                            <Button round color="info">6</Button>
                                            <Button round color="info">7</Button>
                                        </ButtonGroup>
                                    </ButtonToolbar>
                                </CardBody>
                            </Col>
                        ...
                        <Row>
                            <Col xs={12}>
                                <CardHeader><CardTitle>Social buttons</CardTitle></CardHeader>
                                <CardBody>
                                    <Row>
                                        <Col md={4} sm={5} xs={12}>
