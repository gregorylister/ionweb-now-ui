                                        ...
                                        <Col md={12} className="text-center">
                                            ...
                                            <Modal isOpen={this.state.modalClassic} toggle={this.toggleModalClassic}>
                                                ...
                                                <ModalFooter>
                                                    ...
                                                    <Button color="danger" onClick={this.toggleModalClassic}>
                                                        Close
                                                    </Button>
                                                </ModalFooter>
                                            </Modal>
                                            ...
                                            <Modal isOpen={this.state.modalNotice} toggle={this.toggleModalNotice} className="modal-notice">
                                                <ModalHeader toggle={this.toggleModalNotice} className="title-up">
                                                ...
                                                <ModalFooter className="justify-content-center">
                                                    <Button color="info" round onClick={this.toggleModalNotice}>Sounds good!</Button>
                                                </ModalFooter>
                                            </Modal>
                                            <Button color="warning" onClick={this.toggleModalMini}>
                                                Small alert modal
                                            </Button>
                                            <Modal isOpen={this.state.modalMini} toggle={this.toggleModalMini} size="mini" modalClassName="modal-primary">
