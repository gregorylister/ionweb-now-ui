                ...
                <div className="content">
                    <Row className="justify-content-center">
                        <Col lg={6} md={8} xs={12}>
                            <Card>
                                <CardHeader>
                                    <CardTitle>Navigation Pills - <small className="description">Horizontal Tabs</small></CardTitle>
                                </CardHeader>
                                <CardBody>
                        ...
                        <Col lg={6} md={8} xs={12}>
                            <Card>
                                <CardHeader>
                                    <CardTitle>Navigation Pills - <small className="description">Vertical Tabs</small></CardTitle>
                                </CardHeader>
                                <CardBody>
                                    <Row>
                                        <Col md={4} xs={12}>
                    ...
                    <Row className="justify-content-center">
                        ...
                        <Col lg={6} md={8} xs={12}>
                            <Card>
                                <CardHeader>
                                    <CardTitle>Navigation Pills Icons - <small className="description">Vertical Tabs</small></CardTitle>
                                </CardHeader>
                                <CardBody>
                                    <Row>
                                        <Col xs={12} md={6} lg={3}>
                    ...
                    <Row>
                        <Col md={8} xs={12} className="ml-auto mr-auto">
                            <Card className="card-plain card-subcategories">
                                <CardHeader>
                                    <CardTitle className="text-center">Page Subcategories</CardTitle>
                                    <br />
                                </CardHeader>
                                <CardBody>
