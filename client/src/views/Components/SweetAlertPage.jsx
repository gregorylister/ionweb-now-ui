                    ...
                    <div className="places-sweet-alerts">
                            ...
                            <Col md={3} xs={12} className="ml-auto">
                                <Card>
                                    <CardBody className="text-center">
                                        ...
                                        <Button color="primary" onClick={this.basicAlert.bind(this)}>Try me!</Button>
                                    </CardBody>
                                </Card>
                            </Col>
                            <Col md={3} xs={12} className="mr-auto">
                                <Card>
                                    <CardBody className="text-center">
                                        ...
                                        <Button color="primary" onClick={this.successAlert.bind(this)}>Try me!</Button>
                                    </CardBody>
                                </Card>
                            </Col>
                        </Row>
                            ...
                            <Col md={3} xs={12} className="ml-auto">
                                <Card>
                                    <CardBody className="text-center">
                                        ...
                                        <Button color="primary" onClick={this.htmlAlert.bind(this)}>Try me!</Button>
                                    </CardBody>
                                </Card>
                            </Col>
                            <Col md={3} xs={12} className="mr-auto">
                                <Card>
                                    <CardBody className="text-center">
                                        <CardText>A warning message, with a function attached to the "Confirm" Button...</CardText>
                                        <Button color="primary" onClick={this.warningWithConfirmMessage.bind(this)}>Try me!</Button>
                                    </CardBody>
                                </Card>
                            </Col>
                        </Row>
                            ...
                            <Col md={3} xs={12} className="ml-auto">
                                <Card>
                                    <CardBody className="text-center">
                                        ...
                                        <Button color="primary" onClick={this.inputAlert.bind(this)}>Try me!</Button>
                                    </CardBody>
                                </Card>
                            </Col>
                            <Col md={3} xs={12} className="mr-auto">
                                <Card>
                                    <CardBody className="text-center">
                                        ...
                                        <Button color="primary" onClick={this.titleAndTextAlert.bind(this)}>Try me!</Button>
                                    </CardBody>
                                </Card>
                            </Col>
                        </Row>
                        <Row>
                            <Col md={3} xs={12} className="ml-auto">
                                <Card>
                                    <CardBody className="text-center">
                                        <CardText>A message with auto close timer set to 2 seconds</CardText>
                                        <Button color="primary" onClick={this.autoCloseAlert.bind(this)}>Try me!</Button>
                                    </CardBody>
                                </Card>
                            </Col>
                            <Col md={3} xs={12} className="mr-auto">
                                <Card>
                                    <CardBody className="text-center">
                                        <CardText>...and by passing a parameter, you can execute something else for "Cancel"</CardText>
                                        <Button color="primary" onClick={this.warningWithConfirmAndCancelMessage.bind(this)}>Try me!</Button>
                                    </CardBody>
                                </Card>
                            </Col>
                        </Row>
