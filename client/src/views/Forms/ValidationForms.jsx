                    ...
                    <Row>
                            ...
                            <Form>
                                <Card>
                                    ...
                                    <CardFooter className="text-right">
                                        ...
                                        <Button color="primary" onClick={(e) => this.registerSubmit(e)}>Register</Button>
                                    </CardFooter>
                                </Card>
                            </Form>
                        </Col>
                            ...
                            <Form>
                                <Card>
                                    ...
                                    <CardFooter className="text-center">
                                        <Button color="primary" onClick={(e) => this.loginSubmit(e)}>Login</Button>
                                    </CardFooter>
                                </Card>
                            </Form>
                        </Col>
                        <Col xs={12}>
                            <Form className="form-horizontal">
                                <Card>
                                    <CardHeader><CardTitle>Type Validation</CardTitle></CardHeader>
                                    <CardBody>
                                        <Row>
                                            <Label sm={2}>Required Text</Label>
                                            <Col xs={12} sm={7}>
                                                <FormGroup className={this.state.type.requiredState}>
                                                    <Input type="text" onChange={(e) => this.typeRequired(e)}/>
                                                </FormGroup>
                                            </Col>
                                            <Label sm={3} className="label-on-right"><code>required</code></Label>
                                        </Row>
                                        <Row>
                                            <Label sm={2}>Email</Label>
                                            <Col xs={12} sm={7}>
                                                <FormGroup className={this.state.type.emailState}>
                                                    <Input type="email" onChange={(e) => this.typeEmail(e)}/>
                                                </FormGroup>
                                            </Col>
                                            <Label sm={3} className="label-on-right"><code>email</code></Label>
                                        </Row>
                                        <Row>
                                            <Label sm={2}>Number</Label>
                                            <Col xs={12} sm={7}>
                                                <FormGroup className={this.state.type.numberState}>
                                                    <Input type="text" onChange={(e) => this.typeNumber(e)}/>
                                                </FormGroup>
                                            </Col>
                                            <Label sm={3} className="label-on-right"><code>number</code></Label>
                                        </Row>
                                        <Row>
                                            ...
                                            <Label sm={3} className="label-on-right"><code>url</code></Label>
                                        </Row>
                                        <Row>
                                            <Label sm={2}>Equal to</Label>
                                            <Col xs={12} sm={3}>
                                                <FormGroup className={this.state.type.equalState}>
                                                    <Input type="text" onChange={(e) => this.typeSource(e)} placeholder="#idSource"/>
                                                </FormGroup>
                                            </Col>
                                            <Col xs={12} sm={3}>
                                                <FormGroup className={this.state.type.equalState}>
                                                    <Input type="text" onChange={(e) => this.typeDestionation(e)} placeholder="#idDestination"/>
                                                </FormGroup>
                                            </Col>
                                            <Label sm={3} className="label-on-right"><code>equalTo</code></Label>
                                        </Row>
                                    </CardBody>
                                    <CardFooter className="text-center">
                                        <Button color="primary" onClick={(e) => this.typeValidate(e)}>Validate Inputs</Button>
                                    </CardFooter>
                                </Card>
                            </Form>
                        </Col>
                        <Col xs={12}>
                            <Form className="form-horizontal">
                                <Card>
                                    <CardHeader><CardTitle>Range Validation</CardTitle></CardHeader>
                                    <CardBody>
                                        <Row>
                                            <Label sm={2}>Min length</Label>
                                            <Col xs={12} sm={7}>
                                                <FormGroup className={this.state.range.minLengthState}>
                                                    <Input type="text" onChange={(e) => this.rangeMinL(e)}/>
                                                </FormGroup>
                                            </Col>
                                            <Label sm={3} className="label-on-right"><code>minLength="5"</code></Label>
                                        </Row>
                                        <Row>
                                            <Label sm={2}>Max length</Label>
                                            <Col xs={12} sm={7}>
                                                <FormGroup className={this.state.range.maxLengthState}>
                                                    <Input type="text" onChange={(e) => this.rangeMaxL(e)}/>
                                                </FormGroup>
                                            </Col>
                                            <Label sm={3} className="label-on-right"><code>maxLength="5"</code></Label>
                                        </Row>
                                        <Row>
                                            <Label sm={2}>Range</Label>
                                            <Col xs={12} sm={7}>
                                                <FormGroup className={this.state.range.rangeState}>
                                                    <Input type="text" onChange={(e) => this.rangeRange(e)}/>
                                                </FormGroup>
                                            </Col>
                                            <Label sm={3} className="label-on-right"><code>range="[6,10]"</code></Label>
                                        </Row>
                                        <Row>
                                            ...
                                            <Label sm={3} className="label-on-right"><code>min="6"</code></Label>
                                        </Row>
                                        <Row>
                                            ...
                                            <Label sm={3} className="label-on-right"><code>max="6"</code></Label>
                                        </Row>
                                    </CardBody>
                                    <CardFooter className="text-center">
                                        <Button color="primary" onClick={(e) => this.rangeValidate(e)}>Validate Inputs</Button>
                                    </CardFooter>
                                </Card>
                            </Form>
                        </Col>
