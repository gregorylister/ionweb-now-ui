                                    ...
                                    <Table responsive striped>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td className="td-price"><small>€</small> 35,999</td>
                                            </tr>
                                        </tbody>
                                    </Table>
                                </CardBody>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td className="td-actions">
                                                    ...
                                                    <UncontrolledTooltip placement="left" target="remove1" delay={0}>Remove item</UncontrolledTooltip>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td className="td-actions">
                                                    ...
                                                    <UncontrolledTooltip placement="left" target="remove2" delay={0}>Remove item</UncontrolledTooltip>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td className="td-actions">
                                                    ...
                                                    <UncontrolledTooltip placement="left" target="remove3" delay={0}>Remove item</UncontrolledTooltip>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colSpan="3"></td>
