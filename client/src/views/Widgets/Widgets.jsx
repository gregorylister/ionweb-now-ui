                        ...
                        <Col xs={12} sm={6} md={6} lg={3}>
                            <Card className="card-stats">
                                ...
                                <CardFooter>
                                    <Stats>
                                        {[
                                            { i: "now-ui-icons arrows-1_refresh-69", t: " Update now "}
                                        ]}
                                    </Stats>
                                </CardFooter>
                            </Card>
                        ...
                        <Col xs={12} sm={6} md={6} lg={3}>
                            <Card className="card-stats">
                                ...
                                <CardFooter>
                                    <Stats>
                                        {[
                                            { i: "now-ui-icons ui-2_time-alarm", t: " In the last hour "}
                                        ]}
                                    </Stats>
                                </CardFooter>
                            </Card>
                        ...
                        <Col xs={12} md={12} lg={6} className="text-center">
                            <Card className="card-contributions">
                                <CardBody>
                                    ...
                                    <CardDescription>After a very successful two-year run, we’re going to be changing the way that contributions work.</CardDescription>
                                </CardBody>
                                <hr />
                                <CardFooter>
                                    <Row>
                    ...
                    <Row>
                            ...
                            <Row>
                                <Col xs={12} lg={6}>
                                    <Card className="card-pricing">
                                        ...
                                        <CardBody>
                                            <CardIcon color="primary" icon="now-ui-icons objects_diamond"/>
                                ...
                                <Col xs={12} lg={6}>
                                    <Card className="card-pricing card-plain">
                                        ...
                                        <CardBody>
                                            <CardIcon color="warning" icon="now-ui-icons media-1_button-power"/>
                        ...
                        <Col xs={12} md={6}>
                            <Card className="card-testimonial">
                                ...
                                <CardBody>
                                    <CardDescription>The networking at Web Summit is like no other European tech conference.</CardDescription>
